...
Memoize the Ackermann function from Exercise 6-2 and see if memoization makes
...
def ackermann(second_number, first_number):
    ...
    if (second_number, first_number) in dict_variable:
        ...
        dict_variable[second_number, first_number] = ackermann(
            second_number - 1, ackermann(second_number, first_number - 1)
        )
        return dict_variable[second_number, first_number]
