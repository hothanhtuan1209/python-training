...
class PokerHand(Hand):
    ...
    def has_pair(self):
        ...
        Returns:
            bool: True if the hand contains at least one pair (two cards of
            the same rank), False otherwise.
        """
    ...
    def has_full_house(self):
        ...
        A full house consists of a three of a kind and a pair. There are three
        possible variations
        in a 7-card hand:
