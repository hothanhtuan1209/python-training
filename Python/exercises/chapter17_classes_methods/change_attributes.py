...
class Time(object):
    ...
    def __str__(self):
        """
        Returns a string representation of the Time object in the form
        'hour:minute:second'.
    ...
    def print_time(self):
        """
        Prints the time in the form of an integer representing the total
        seconds.
        """
    ...
    def is_after(self, other):
        """
        Checks if the time represented by this Time object is after the time
        represented by another Time object.

        other: Time object or number of seconds

        Returns:
            bool: True if the time represented by this Time object is after
            the time represented by the 'other' Time object, False otherwise.
        """
