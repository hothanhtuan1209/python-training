...
- Write the more general version that computes the day when one person is n
...
def birthday_countdown(birthday_month, birthday_day):
    ...
    if current_date > next_birthday:
        next_birthday = datetime(current_date.year + 1, birthday_month,
                                 birthday_day
                                 )
...
def main():
    ...
    print('The day when one person is n times older than the other is', 
          result_ratio.strftime(DATE_FORMAT))
