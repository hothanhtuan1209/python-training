...
class Person:
    ...
    Methods:
        __init__(self, name, age): Initializes a Person object with the given
        name and age.
    ...
    def __gt__(self, other):
        ...
        Returns:
            bool: True if the age of this person is greater than the other
            person's age, False otherwise.
        """
